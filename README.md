...
__구현 주의사항__ 에 코드 작성하면서 겪었던 런타임 에러나 오류들 기록   
코드를 사용할 때의 주의사항이 아니라 해당 코드 구현하면서 겪은 주의사항을 기록   
__시간복잡도__ 는 LaTeX 수식 사용.
__사용설명__ 은 코드 사용할 때 참고할 내용 기록   
__문제__ 에는 혹시 코드 수정하게 됐을 때 테스트해볼 만한 문제 링크 적어두기   
...
* ### [DP](/DP/Top-Down%20DP.md)
  ...
  * <span class="additional">[배낭문제(G-)](/DP/배낭문제.md)</span>
    ...
    * <span class="platinum">[Bounded Knapsack(Binary Splitting) (P-)](/DP/배낭문제.md#bounded-knapsack-problem-binary-splitting)</span>
    * <span class="platinum">[비트셋 배낭(P-)](/DP/배낭문제.md#bitset-knapsack)</span>
    * <span class="diamond">[O(W sqrt(W)) 비트셋 배낭(D-)](/DP/배낭문제.md#OW-sqrtW-bitset-knapsack)</span>
